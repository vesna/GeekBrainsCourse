...
public abstract class MysticalMan extends Unit {
    ...
    public MysticalMan(int attack, int defense, float minDamage, float maxDamage, float hp, int speed, ArrayList<Unit> name,
